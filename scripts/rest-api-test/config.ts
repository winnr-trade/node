import { Secp256k1Signer, Ed25519Signer } from "@sovereign-sdk/signers";
...
// export const tokenMinterSigner = new Secp256k1Signer(
//   tokenMinterKey.private_key,
// );
// export const adminSigner = new Secp256k1Signer(adminKey.private_key);
// export const userSigner = new Secp256k1Signer(userKeys.data[0]!.private_key);
...
export const userSigner = new Ed25519Signer(userKeys.data[0]!.private_key);
...
export const userAddress = userKeys.data[0]!.address;
